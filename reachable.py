...
# (the Rust extension doesn't expose itself as an attribute) - without it, apworlds
# doing that import (e.g. clair_obscur) fail to load and their game is unregistered.
try:
